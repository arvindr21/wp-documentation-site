...
function excellent_admin_css (){

  wp_enqueue_style( 'excellent-admin-css', get_template_directory_uri() . '/css/admin/admin.css' );

}

add_action( 'admin_enqueue_scripts', 'excellent_admin_css' );
...
function excellent_admin_notice() {
  ...
  if ( !get_user_meta( $current_user_id, esc_html( $theme->get( 'TextDomain' ) ) . '_notice_ignore' ) ) {
    ?>
    <div class="notice excellent-notice">
