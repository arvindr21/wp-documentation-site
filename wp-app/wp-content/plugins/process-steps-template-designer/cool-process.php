...
if (!defined('COOL_PROCESS_VERSION_CURRENT'))
    define('COOL_PROCESS_VERSION_CURRENT', '1.2.1');
...
if (!class_exists('CoolProcess')) {
    ...
    class CoolProcess {
        ...
        public function __construct() {
            ...
            if(is_admin()){   
            require_once COOL_PROCESS_PLUGIN_DIR . '/feedback/admin-feedback-form.php';
        ...
        public function pp_add_tinymce_plugin($plugin_array) {
            $plugin_array['cool_process'] =COOL_PROCESS_PLUGIN_URL.'/js/process-button-script.js';
            return $plugin_array;
        }
