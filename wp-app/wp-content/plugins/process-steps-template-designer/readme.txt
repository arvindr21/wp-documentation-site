...
<storng>This plugin is used for creating:- </strong>
<ul>
<li>How its Works</li>
<li>Our Process Creator</li>
<li>Step By Step Tutorial Designer</li>
<li>Software Lifecycle Showcase</li>
...
Added:- Formating (Support HTML & CSS)
...
Added:-Integrated brand new vertical process layout.Now user can create beautifull vertical process line
Improvement:- Integrated slider on all process layout. 
Improvement:- Improved overall code of plugin.
Added:-Integrated dynamic color and icon size option in vertical process shortcode generator
