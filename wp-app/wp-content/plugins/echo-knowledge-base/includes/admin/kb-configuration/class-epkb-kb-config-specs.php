	...
	public static function shared_configuration() {
		...
		$shared_specification = array(
			...
			'section_hyperlink_text_on' => array(
				'label'       => __( 'Category Link', 'echo-knowledge-base' ),
				'name'        => 'section_hyperlink_text_on',
				'info'        => __( 'Whether category text should have a link to Category Archive page.' ),
				'type'        => EPKB_Input_Filter::CHECKBOX,
				'default'     => $default_style['section_hyperlink_text_on']
			),
