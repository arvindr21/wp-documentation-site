...
* Basic Layout - Demo 1 [here](https://www.echoknowledgebase.com/demo-1-knowledge-base-basic-layout/ "KB Demo 1")
* Basic Layout - Demo 2 [here](https://www.echoknowledgebase.com/demo-2-knowledge-base-basic-layout/ "KB Demo 2")
* Tabs Layout - Demo 3 [here](https://www.echoknowledgebase.com/demo-3-knowledge-base-tabs-layout/ "KB Demos 3") (Multi Product Example)
* Tabs Layout - Demo 4 [here](https://www.echoknowledgebase.com/demo-4-knowledge-base-tabs-layout/ "KB Demos 4") (Multi Product Example)


= Why Choose Echo Knowledge Base for Your Business? =
* This is already a proven product with a 5-star rating from more than 10,000 customers.
* Get a truly professional look with the option to customize nearly all components.
* Easily organize your content by team, product, service, and more using Tabs Layout.
* Extend it to fit any organization, big or small.
* Get friendly support, seven days a week.
* Use add-ons to enhance your Knowledge Base with more professional features.
* Get regular updates and new features.
* Use it to answer customer questions and save on support tickets.


= Features of the Knowledge Base Plugin =
* Ready to use as soon as it’s installed
* A fast search bar with listed results
* An easy and flexible style and behavior customization
* Adaptation to any device including tablets and phones
* Multiple levels of categories and sub-categories for hierarchical documentation
* Creation of as many Products as you need using Tabs layout.
* Ordering articles and categories alphabetically, chronologically, or in any order
* Over 500 icons to display for top categories
* 16 pre-defined color themes
* Choice of your theme or Knowledge Base theme
* 4 pre-defined style combinations
* Ability to add tags, breadcrumbs, back button and comments to your knowledgebase articles
* Visual builder for styling your knowledge base main pageCoded for best SEO results
* Text in any language and all text translatable via .pot files
* Can be used with or without Gutenberg
* Compatible with WPML, Elementor, Visual Composer, and others


= Additional Features with Professional Add-ons =
* The ability to control access based on groups, WordPress roles, and custom roles.
* Fine-tuned control of who can access and see content.
* Multiple knowledge bases with separate articles, categories, tags, and more.
* Six widgets for categories, articles, the search bar, and others.
* The option to replace articles with PDFs, external documents, video links, and more.
* Sidebar and Grid layouts.
* Advanced search filtered by category.
* Advanced search analytics to determine the most popular and empty searches.
* Advanced search with custom backgrounds and support links.
* The ability to control who can read, write, and edit articles.
* Voting on articles, a feedback form, and analytics (coming soon).


= How Our Customers Use the Echo Knowledge Base =
...
4. Another Example of the Tabs Layout

5. Article with breadcrumbs, back button, tags and comments

6. Knowledge Base configuration settings in visual builder
...
= 4.7.1, Sept 28, 2019 =
* Fix: category links for tabs layout
* Update: add option to switch on or off category links in Tabs layout

= 4.7.0, Sept 26, 2019 =
* New: category links for tabs layout
* Update: improve visibility of sections for KB configuration
* Update: code refactoring

= 4.6.1, Sept 15, 2019 =
* Update: Chrome HTML engine build 77 broke CSS. Apply temporary fix.

= 4.6.0, Aug 3, 2019 =
* New: category links for basic layout
